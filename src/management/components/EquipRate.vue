...
<template>
  ...
  <div class="er-todo">
    ⚠ 装备率精确计算公式（分子/分母口径）【待补充：陈思远梳理】 | 汽车之家/威尔森数据接口规格【待补充：数据侧】 | 缺车型兜底呈现规则【待补充：待定】
  </div>
  ...
  <div v-if="showAddModal" class="modal-mask" @click.self="showAddModal = false">
    <div class="modal" style="max-width: 560px">
      ...
      <div class="modal-desc">从配置原子库选择配置项，拉取近三年装备率数据后自动按阈值归类（当前为趋势区间示例数据）</div>
...
.er-todo { font-size: 11.5px; color: var(--c-text-muted); margin-top: 10px; line-height: 1.7; }
